...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="protocolforbuss.aspx.cs" Inherits="API.WebUI201509.Security.SecurityCenter.protocolforbuss" %>
...
<title>Kdpay-Protocol for business upload</title>
        ...
        { %>
	                <p>
						...
						<span class="span2" style="width:auto;">
							<input id="realname" name="realname" type="text" value="<%= personName %>" autocomplete="off" class="yxkeleyi" style="width:300px;color:#666666;">
                           
						</span>
						<span class="span3" style="width:auto; min-width: 40px;"></span>
					</p>
                    <p>
						<span class="span1">Business License No:</span>
						<span class="span2" style="width:auto;">
           ...
           <p>
					...
					<p>
						<span class="span1">business license(.jpg):</span>
                    ...
                    <p>
						<span class="span1">Tax registration certificate(.jpg):</span>
						<span class="span2 pr">
							<i class="pa">upload files</i>
                     ...
                     <p>
						<span class="span1">Organization code certificate(.jpg):</span>
						<span class="span2 pr">
							<i class="pa">upload files</i>
                            <input id="IdNoImageC" type="file" name="IdNoImageC" accept=".jpg" class="transparent hand"/>
						</span>
						<span class="span3"></span>
					</p>
                     <p>
						<span class="span1">permission for opening bank account(.jpg):</span>
						<span class="span2 pr">
							<i class="pa">upload files</i>
                            <input id="IdNoImageD" type="file" name="IdNoImageD" accept=".jpg" class="transparent hand"/>
						</span>
						<span class="span3"></span>
					</p>
                    <p>
						<span class="span1">Corporate identity card positive and negative(.jpg):</span>
						<span class="span2 pr">
							<i class="pa">upload files</i>
                            <input id="IdNoImageE" type="file" name="IdNoImageE" accept=".jpg" class="transparent hand"/>
						</span>
						<span class="span3"></span>
					</p>
                    <p>
        ...
        <div class="manage-goods-child bind-content">
						<div class="manage-goods-child-one">
							<div class="attestation">
								<p><span class="span1">Company Name：</span><span class="span2" style="font-weight:bold; width:320px; color:#666666;"><%= CurrentUser.personName %></span></p>
								<p><span class="span1">business license：</span><span class="span2" style="font-weight:bold; width:320px; color:#666666;"><%= UserViewIdCard %></span></p>
								...
								<% if (CurrentUser.procstatus == 4)
                                  { %>
                                 <p><span class="span1">Description of the audit：</span><span class="span2" style="font-weight:bold; width:500px; color:#666666;"><%= reason %></span></p>
								<% } %>
                                <!-- Can be changed -->
								<p>
										<span class="span1"></span>
...
<% if (CurrentUser.procstatus == 4)
   { %>
											<a href="/security/securitycenter/protocolforbuss.aspx?redo=1" style="width:100px; height:35px; background-color:#e58c15; float:left;  text-align:center; color:#ffffff; font-size:14px; font-weight:500; border-radius:4px;">重新提交</a>
										<% } %>
                                        </span>
									</p>
								</div>
        ...
        $("#protocoluploadform").validate({
            ...
            messages: {
                ...
                idno: {
                    ...
                    isValidBusCode: "Please enter a valid business license number"
                },
                hosts: {
    ...
    function ajaxFileUpload() {
        if ($("#protocoluploadform").valid()) {
            ...
            $.ajaxFileUpload({
                ...
                secureuri: false,
                fileElementId: ['IdNoImageA', 'IdNoImageB','IdNoImageC', 'IdNoImageD','IdNoImageE',  'protocal'],
